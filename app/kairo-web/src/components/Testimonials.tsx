...
function TestimonialCard({ testimonial }: { testimonial: Testimonial }) {
  ...
  return (
    ...
    >
      {/* Opening quote mark — large accent color */}
      <span
    ...
    >
      <div className="mx-auto max-w-6xl">
        ...
        {/*
          ...
          Desktop: 2-column grid
          The scroll container has no visible scrollbar on WebKit.
        */}
        <div
          className="
        ...
        {/* Social proof bar */}
        {/* PLACEHOLDER — replace with real logo strip or remove if not needed */}

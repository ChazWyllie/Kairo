...
A couple of tips for getting the most out of this: break the work into chunks if your codebase is large — you can tell Claude Code to focus on Dashboard A first, then Dashboard B, then shared utilities. And once you get the bug report back, you can feed the bugs back one at a time with "Fix BUG-001" and it'll have full context on what to do.